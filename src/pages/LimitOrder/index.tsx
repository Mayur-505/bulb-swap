...
export default function LimitOrder({ history }: RouteComponentProps) {
  ...
  return (
    <>
      ...
      <NetworkAlert />
      <AppBody>
        <SwapHeader title="Limit Order" allowedSlippage={allowedSlippage} />
        <Wrapper id="limit-order-page">
          ...
          <AutoColumn gap={'sm'}>
            ...
            <RateInputPanel
              ...
              onUserInput={(value) => onLimitOrderValuesChange('price', value)}
                ...
                <RowFixed>
                  <LoadingOpacityContainer $loading={routeIsSyncing}>
                    ...
                    <AutoRow justify="flex-end">
                      <ConditionText severity={limitOrderMarketStats > 0 ? 0 : limitOrderMarketStats === 0 ? 1 : 4}>
                        {Math.abs(limitOrderMarketStats).toFixed(2)}% {limitOrderMarketStats > 0 ? 'above' : 'below'}{' '}
                        market value
                      </ConditionText>
                    </AutoRow>
                  </LoadingOpacityContainer>
            ...
            <div>
              {swapIsUnsupported ? (
                    ...
                    >
                      <Text fontSize={16} fontWeight={500}>
                        {priceImpactTooHigh ? (
                          ...
                          <Trans>Place Order Anyway</Trans>
                        ) : (
                ...
                <ButtonError
                  ...
                  id="swap-button"
                  disabled={!isValid || priceImpactTooHigh || !!swapCallbackError || limitOrderMarketStats <= 0}
