...
import { coin98, injected } from '../../connectors'
...
export default function WalletModal({
  ...
  function getOptions() {
    ...
    const isMetamask = ethereum && ethereum.isMetaMask && !ethereum.isCoin98
    ...
    return Object.keys(SUPPORTED_WALLETS).map((key) => {
      ...
      if (option.connector === injected) {
        ...
        else if (option.name === 'Injected' && (isMetamask || isCoin98)) {
          return null
        }
      }

      if (option.connector === coin98 && !isCoin98) {
        return null
      }
        ...
        <UpperSection>
          ...
          <ContentWrapper>
            {error instanceof UnsupportedChainIdError ? (
              <h5>
                <Trans>Please connect to BSC or AVAX.</Trans>
              </h5>
            ) : (
