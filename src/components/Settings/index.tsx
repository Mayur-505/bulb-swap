...
import { useAutonomyPaymentManager, useClientSideRouter, useExpertModeManager } from '../../state/user/hooks'
        ...
        <MenuFlyout>
          <AutoColumn gap="md" style={{ padding: '1rem' }}>
            ...
            <RowBetween>
              <RowFixed>
                <ThemedText.Black fontWeight={400} fontSize={14} color={theme.text2}>
                  <Trans>Pre-pay execution</Trans>
                </ThemedText.Black>
                <QuestionHelper
                  text={<Trans>Only available for Limit Order and Stop Loss powered by Autonomy Network</Trans>}
                />
              </RowFixed>
              <Toggle id="toggle-prepay-mode-button" isActive={autonomyPrepay} toggle={togglePrepayMode} />
            </RowBetween>
          </AutoColumn>
        </MenuFlyout>
      )}
