...
function AutonomyTransactionSummary({ info }: { info: AutonomyTransactionInfo }) {
  return <Trans>Custom {info.summary}</Trans>
}
...
export function TransactionSummary({ info }: { info: TransactionInfo }) {
  switch (info.type) {
    ...
    case TransactionType.STOP_LOSS:
      return <AutonomyTransactionSummary info={info} />
  }
}
