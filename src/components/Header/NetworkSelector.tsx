...
export default function NetworkSelector() {
  ...
  const bscInfo = CHAIN_INFO[SupportedChainId.BSC]
  ...
  return (
    <SelectorWrapper ref={node as any}>
      <SelectorControls onClick={conditionalToggle} interactive={showSelector}>
        <SelectorLogo interactive={showSelector} src={info.logoUrl || bscInfo.logoUrl} />
      ...
      {open && (
        <FlyoutMenu>
          ...
          <Row targetChain={SupportedChainId.BSC} />
          <Row targetChain={SupportedChainId.AVAX} />
        </FlyoutMenu>
      )}
    </SelectorWrapper>
  )
