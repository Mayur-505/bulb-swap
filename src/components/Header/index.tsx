...
import logoBlack from '../../assets/svg/logo_black.png'
import logoWhite from '../../assets/svg/logo_white.png'
...
export default function Header() {
  ...
  return (
    <HeaderFrame showBackground={false}>
      ...
      <Title href=".">
        <UniIcon>
          <img src={darkMode ? logoWhite : logoBlack} width="48" alt="logo" />
        </UniIcon>
      </Title>
      <HeaderLinks>
        ...
        <StyledNavLink id={`stop-loss-nav-link`} to={'/stop-loss'}>
          ...
          <AccountElement active={!!account}>
            {account && userEthBalance ? (
              <BalanceText style={{ flexShrink: 0, userSelect: 'none' }} pl="0.75rem" pr="0.5rem" fontWeight={500}>
                <Trans>
                  {userEthBalance?.toSignificant(3)} {CHAIN_INFO[chainId].nativeCurrency.symbol}
                </Trans>
              </BalanceText>
            ) : null}
            <Web3Status />
