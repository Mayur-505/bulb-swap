...
export default function ConfirmSwapModal({
  ...
  }, [allowedSlippage, onAcceptChanges, recipient, trade, realSwapPrice, realOutputAmount])
  ...
  const pendingText = (
    <Trans>
      Swapping {trade?.inputAmount?.toSignificant(6)} {trade?.inputAmount?.currency?.symbol} for {realOutputAmount}{' '}
  ...
  const confirmationContent = useCallback(
    () =>
      swapErrorMessage ? (
        ...
        <ConfirmationModalContent
          title={<Trans>Confirm {type}</Trans>}
          onDismiss={onDismiss}
