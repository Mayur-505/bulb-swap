...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [SupportedChainId.BSC]: [...WETH_ONLY[SupportedChainId.BSC], BUSD, USDC_BSC, USDT_BSC],
  [SupportedChainId.AVAX]: [...WETH_ONLY[SupportedChainId.AVAX], USDC_AVAX, USDT_AVAX],
}
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.BSC]: [
    new NativeToken(SupportedChainId.BSC, 18, 'BNB', 'Binance Coin'),
    BUSD,
    USDC_BSC,
    USDT_BSC,
    WETH9_EXTENDED[SupportedChainId.BSC],
  ],
  [SupportedChainId.AVAX]: [
    new NativeToken(SupportedChainId.AVAX, 18, 'AVAX', 'AVAX'),
    USDC_AVAX,
    USDT_AVAX,
    WETH9_EXTENDED[SupportedChainId.AVAX],
  ],
}
